...
### [Thebe Visitor Management System](https://github.com/girination)
> Multi-tenant visitor management PWA for Botswana organisations - QR + alphanumeric check-in, offline-first architecture, SMS notifications, and local payment integrations (Orange Money, MyZaka, DPO Pay).

### Odoo ERP Implementations
> Client ERP roadmaps and module configuration across CRM, Sales, Inventory, and Purchasing - including onboarding calendars, Gantt charts, RACI matrices, and risk registers.
...
- Advanced Supabase (Edge Functions, Row Level Security patterns)
- Odoo Studio & no-code ERP customisation
- Cloud infrastructure & DevOps (Docker, deployment pipelines)
...
- **LinkedIn**: [linkedin.com/in/clinton-giri](https://www.linkedin.com/in/clinton-giri-7172241a0/)
